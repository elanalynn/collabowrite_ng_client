...
function storyService($http){
  ...
  service.updateStory = story => $http.put(`http://localhost:3000/api/v1/stories/${story.id}`, story)
  service.deleteStory = id => $http.delete(`http://localhost:3000/api/v1/stories/${id}`)
